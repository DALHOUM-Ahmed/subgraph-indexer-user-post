...
export function handleSetEmailVerifiedData(event: SetEmailVerifiedDataEvent): void {
  let entity = User.load(event.params._userAddress.toString());
  if (entity !== null) {
...
export function handleSetTelephoneVerifiedData(event: SetTelephoneVerifiedDataEvent): void {
  let entity = User.load(event.params._userAddress.toString());
  if (entity !== null) {
